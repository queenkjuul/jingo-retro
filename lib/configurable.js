...
Configurable.prototype.getConfig = function () {
  try {
    ...
    this.config = _.cloneDeep(configObject.get(), true)
  } catch (e) {
    this.config = _.cloneDeep(configObject.defaults, true)
  }
...
Configurable.prototype.getProxyPath = function () {
  return configObject.getProxyPath(
    this.overrides.application && this.overrides.application.proxyPath
  )
}
